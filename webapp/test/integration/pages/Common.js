sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/schulung/appflights/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("de.schulung.appflights.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["de/schulung/appflights/localService/mockserver"], function(mockserver) {
