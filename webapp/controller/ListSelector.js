sap.ui.define([
	...
	return BaseObject.extend("de.schulung.appflights.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias de.schulung.appflights.model.ListSelector
		 */
		 ...
		 * @return {de.schulung.appflights.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
